...
const IntroCard = () => (
  <ChildCard>
    ...
    <Typography color="textSecondary" variant="subtitle2" mb={2}>
      Hello, I am Darren Woods. I love making websites and graphics. Lorem
      ipsum dolor sit amet, consectetur adipiscing elit.
    </Typography>
    <Stack direction="row" gap={2} alignItems="center" mb={3}>
      <IconBriefcase size="21" />
      <Typography variant="h6">Synapture Ltd.</Typography>
    </Stack>
    <Stack direction="row" gap={2} alignItems="center" mb={3}>
      <IconMail size="21" />
      <Typography variant="h6">darren@synapture.co.uk</Typography>
    </Stack>
    <Stack direction="row" gap={2} alignItems="center" mb={3}>
    ...
    <Stack direction="row" gap={2} alignItems="center" mb={1}>
      <IconMapPin size="21" />
      <Typography variant="h6">Cambridge UK, CB5 8SS</Typography>
    </Stack>
  </ChildCard>
);
