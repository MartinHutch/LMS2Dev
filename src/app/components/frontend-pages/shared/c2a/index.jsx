                    ...
                    <Grid container spacing={3} sx={{
                        ...
                        <Grid
                            ...
                            <Typography
                                ...
                                }}>Develop & Learn with feature-rich Refinery 2.0</Typography>
                            <Stack
                                spacing={{ xs: 1, sm: 2 }}
                                direction="row"
                                useflexgap="true"
                                ...
                                <Button variant="contained" size="large" href="https://www.professionalacademy.com/">Course Purchase & Registration</Button>
                            </Stack>
                            <Typography sx={{
                                fontSize: "14px"
                            }}><Box component="span" sx={{
                                fontWeight: 600
                            }}>Login by prior registration -</Box> course purchase and registration available at professionalacademy.com.</Typography>
                        </Grid>
                    </Grid>
                </Container>
